...
const getAllProperties = function(options, limit = 10) {
  ...
  //     queryString += `WHERE properties.owner_id = 2 `;
  //   } else {
  //   queryString += `AND properties.owner_id = 2 `;
  //   }
  // } ** This code is only meant for testing, as there is not a form to search by owner_id.
...
const addProperty = function(property) {
  ...
  .then(res => {
    ...
    console.log('end values is: ', values)
    return res.rows[0]
  });
}
